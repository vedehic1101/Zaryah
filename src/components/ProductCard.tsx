      ...
      >
        ...
        <div className="relative overflow-hidden">
          ...
          <motion.button
            ...
            className="absolute bottom-2 right-2 sm:bottom-4 sm:right-4 bg-cream-100/90 backdrop-blur-sm p-2 sm:p-3 rounded-full hover:bg-cream-200 transition-all shadow-soft"
          >
            <Heart 
              className={`w-4 h-4 sm:w-5 sm:h-5 transition-colors ${
                isLiked ? 'text-blush-600 fill-current' : 'text-charcoal-600'
              }`} 
            />
          </motion.button>
            ...
            {showQuickAdd && (
              ...
              >
                <motion.button
                  ...
                  className="bg-blush-600 hover:bg-blush-700 text-white px-4 py-2.5 rounded-full text-sm font-medium transition-all shadow-soft flex items-center space-x-2"
                >
                ...
                <motion.button
                  ...
                  className="bg-mint-600 hover:bg-mint-700 text-white px-4 py-2.5 rounded-full text-sm font-medium transition-all shadow-soft flex items-center space-x-2"
                >
        ...
        <div className="p-2 sm:p-4 lg:p-6 flex-1 flex flex-col">
          ...
          <div className="flex space-x-1 sm:space-x-2 mt-auto">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={handleQuickAdd}
              className="flex-1 bg-blush-600 hover:bg-blush-700 text-white py-2 sm:py-3 rounded-lg font-semibold transition-all duration-300 shadow-soft hover:shadow-warm flex items-center justify-center space-x-1 sm:space-x-2 text-xs sm:text-sm"
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={handleGiftAdd}
              className="bg-mint-600 hover:bg-mint-700 text-white px-2 sm:px-4 py-2 sm:py-3 rounded-lg transition-all duration-300 shadow-soft hover:shadow-warm flex items-center justify-center"
            >
