    ...
    <div className="min-h-screen bg-gradient-elegant">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.button
          ...
          onClick={() => navigate(-1)}
          className="flex items-center space-x-2 text-charcoal-600 hover:text-charcoal-800 mb-8 group"
        >
          ...
          >
            <div className="relative aspect-square bg-cream-100 rounded-2xl overflow-hidden">
              ...
              <div className="absolute top-4 right-4 space-y-2">
                ...
                >
                  <Heart className={`w-5 h-5 ${isLiked ? 'text-red-500 fill-current' : 'text-charcoal-600'}`} />
                </button>
                <button
                  onClick={handleShare}
                  className="bg-white/90 backdrop-blur-sm p-3 rounded-full hover:bg-white transition-colors shadow-lg"
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex-1 bg-blush-600 hover:bg-blush-700 text-white py-4 px-6 rounded-xl font-semibold transition-all flex items-center justify-center space-x-2 shadow-lg"
                >
                ...
                <button
                  ...
                  className="flex-1 bg-charcoal-800 hover:bg-charcoal-900 text-white py-4 px-6 rounded-xl font-semibold transition-all"
                >
                  Buy Now
                </button>
              </div>
